                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ url('Penjualan/'.$Penjualan->nofak_jual)}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control @error('nofak_jual') is-invalid @enderror" readonly value="{{ old('nofak_jual',$Penjualan->nofak_jual) }}" name="nofak_jual" required autofocus>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="date" class="form-control @error('tgl_jual') is-invalid @enderror" value="{{ old('tgl_jual',$Penjualan->tgl_jual) }}" name="tgl_jual" required autofocus>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control @error('user_id') is-invalid @enderror" value="{{ old('user_id',$Penjualan->user_id) }}" name="user_id" required autofocus>
                                                    </div>
                                                </div>
