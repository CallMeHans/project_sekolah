...
<main id="main" class="main">  
    <div class="pagetitle"> 
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./nofak_jual">Master Data</a></li>
                                        ...
                                        <form action="{{ url('penjualan/'.$penjualan->nofak_jual)}}" method="post" enctype="multipart/form-data">
                                          ...
                                          <p>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="text" class="form-control @error('nofak_jual') is-invalid @enderror" readonly="true"   value="{{ old('nofak_jual',$penjualan->nofak_jual) }}"  name="nofak_jual" >
                                                   </div>
                                              </div> 
                                              ...
                                              <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                  <select class ="form-control" id="kode_barang" name="kode_barang">
                                                    ...
                                                    <option value='{{$item -> kode_barang}}'>{{$item -> kode_barang}} -{{$item -> nama_barang}}
                                                    </option>
                                                    @endforeach
                                                    </select>
                                                   </div>
